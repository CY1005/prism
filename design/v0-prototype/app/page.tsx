    ...
    <div className="flex h-screen bg-background">
      ...
      >
        <div className="flex h-14 items-center justify-between border-b border-sidebar-border px-4">
          <h1 className="font-semibold text-sidebar-foreground">Prism</h1>
          <Button
            variant="ghost"
            size="icon"
            className="h-8 w-8"
        ...
        <header className="flex h-14 items-center justify-between border-b border-border bg-card px-6">
          <div className="flex items-center gap-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                <BreadcrumbItem>
                  <BreadcrumbLink href="#">私有云</BreadcrumbLink>
                </BreadcrumbItem>
                <BreadcrumbSeparator>
                  <ChevronRight className="h-4 w-4" />
                </BreadcrumbSeparator>
                <BreadcrumbItem>
                  <BreadcrumbLink href="#">推理服务</BreadcrumbLink>
                </BreadcrumbItem>
                <BreadcrumbSeparator>
                  <ChevronRight className="h-4 w-4" />
                </BreadcrumbSeparator>
          ...
          <div className="mx-auto max-w-4xl space-y-4 p-6">
            ...
            >
              <p className="text-sm leading-relaxed text-foreground">
                支持按需选择 CPU、GPU 物理卡、GPU
                虚拟卡三类资源配置任务。用户可根据实例规格卡上的资源量提示直接选择，也可由运维管理员在规格管理中自定义配置。
              </p>
            </DimensionCard>

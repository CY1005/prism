  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <div className="flex items-center gap-6 border-b border-border px-6">
        ...
        <Link href={`/projects/${projectId}/ai-analysis`} className="border-b-2 border-primary text-primary font-medium pb-3 pt-2 text-sm">
          AI 需求分析
        </Link>
        <Link href={`/projects/${projectId}/data-flow`} className="text-muted-foreground hover:text-foreground pb-3 pt-2 text-sm">
          数据流转
        </Link>

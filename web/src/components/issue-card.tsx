      ...
      {filtered.length === 0 ? (
        ...
        filtered.map((issue) => {
          ...
          return (
            <div
              key={issue.id}
              className="flex items-start gap-3 rounded-md border border-border p-3 group"
            >
              <div
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-sm font-medium truncate">{issue.description}</span>
                </div>
              ...
              <Button
                variant="ghost"
                size="sm"
                className="h-7 w-7 p-0 opacity-0 group-hover:opacity-100 transition-opacity shrink-0 text-destructive"

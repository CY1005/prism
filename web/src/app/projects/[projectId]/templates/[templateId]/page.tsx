...
export default function TemplateDetailPage() {
  ...
  if (loading) return <p className="p-6 text-muted-foreground">加载中...</p>;
  if (!template) return <p className="p-6 text-muted-foreground">模板不存在</p>;
        ...
        <div>
          ...
          {editing ? (
            <div className="mt-2 space-y-2">
              <input
                className="border rounded px-3 py-1 w-full text-lg font-bold"
                value={editName}
